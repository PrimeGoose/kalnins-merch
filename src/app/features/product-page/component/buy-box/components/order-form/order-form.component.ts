...
@Component({
  ...
  template: `
    ...
    >
      <span class="flex row justify-center">
    ...
    <div
      *ngIf="selected_count_in_cart > 0"
      class="text-white py-2 mt-2 rounded text font-black font-serif w-[200px] bg-gradient-to-r from-orange-700 via-orange-500 to-orange-800 border-gray-700 flex row justify-around"
    >
      <!-- title -->
